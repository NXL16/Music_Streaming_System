...
export default function AmpShuffleButton({
  ...
  useLayoutEffect(() => {
    ...
    const btn = shadow?.querySelector<HTMLButtonElement>(".button--shuffle");
    if (btn) {
