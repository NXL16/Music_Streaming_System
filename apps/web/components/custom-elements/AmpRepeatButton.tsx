...
export default function AmpRepeatButton() {
  ...
  useLayoutEffect(() => {
    ...
    if (btn && ampIcon) {
      btn.className = "";
      btn.classList.add(`button--repeat`, `mode--${repeatMode}`);
      btn.setAttribute("aria-checked", repeatMode > 0 ? "true" : "false");
