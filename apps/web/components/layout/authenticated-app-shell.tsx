      ...
      <div className="min-h-full">
        ...
        >
          ...
          <div
            ...
            className="flex flex-col [grid-area:structure-main-section] h-auto overflow-x-hidden overflow-y-auto w-full will-change-scroll transition-[margin,width] duration-100 ease-linear z-(--z-default) min-[484px]:mt-0 min-[484px]:ps-(--web-navigation-width) min-[484px]:col-span-full"
          >
            <main className="grow">
