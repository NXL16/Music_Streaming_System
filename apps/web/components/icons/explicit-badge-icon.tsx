export function ExplicitBadgeIcon() {
  return (
    <svg
      viewBox="0 0 9 9"
      width="9"
      height="9"
      className="inline-block align-baseline h-(--explicitBadgeSize,auto) w-(--explicitBadgeSize,auto) fill-(--explicitFillOverride,var(--systemSecondary))"
      aria-hidden="true"
    >
