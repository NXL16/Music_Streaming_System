export default function OfflineArtworkFallback() {
  return (
    <div className="rounded-[inherit] [transition:var(--global-transition,opacity_.1s_ease-in)] block h-(--artwork-override-height,100%) max-h-(--artwork-override-max-height,none) max-w-(--artwork-override-max-width,none) min-h-(--artwork-override-min-height,0) min-w-(--artwork-override-min-width,0) overflow-hidden w-(--artwork-override-width,100%) [--offline-artwork-icon:rgba(60,60,67,.18)] dark:[--offline-artwork-icon:rgba(235,235,245,.16)]">
      <div className="bg-(--genericJoeColor) size-full">
        <svg
          viewBox="0 0 100 100"
