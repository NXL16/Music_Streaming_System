        ...
        style={
          isHero
            ? ({
                ...
                "--metadata-tertiary-color": metadataTextTertiary ?? metadataTextPrimary ?? "#ffffff",
