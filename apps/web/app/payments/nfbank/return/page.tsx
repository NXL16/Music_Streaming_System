...
function PaymentReturnContent() {
  ...
  const status =
    resultCode === "0" || resultCode === "99" ? "success" : resultCode ? "failed" : "processing";
        ...
        {status === "processing" && (
          <div className="space-y-4">
            <h2 className="text-xl font-semibold">
              Đang xác thực giao dịch NFBank...
            </h2>
            <p className="text-sm text-neutral-400">
              Vui lòng giữ kết nối, hệ thống đang đồng bộ hóa dòng tiền với ngân hàng.
            </p>
          </div>
        )}
        ...
        {status === "success" && (
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-neutral-400">
                Coin đã được nạp trực tiếp vào ví hệ thống của bạn qua cổng NFBank.
              </p>
            </div>
        ...
        {status === "failed" && (
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-neutral-400">
                Yêu cầu thanh toán ngân hàng đã bị hủy hoặc không thể hoàn tất.
              </p>
            </div>
            ...
            <div className="text-left text-xs bg-blue-950/20 border border-blue-800/20 text-blue-400 p-4 rounded-xl space-y-1">
              <p className="font-bold">💡 Môi trường thử nghiệm (Sandbox):</p>
              <p>
                Nếu ví nhạc của bạn ở thanh bên (sidebar) đã được cộng số dư thành công, điều này có nghĩa là cổng thanh toán đã gửi Webhook thành công. Bạn có thể bỏ qua thông báo lỗi chuyển hướng này của ngân hàng.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 rounded-xl transition-all text-sm"
              >
                Thử nạp lại
              </button>
            </div>
...
export default function NfbankReturnPage() {
  return (
    <Suspense
      fallback={
